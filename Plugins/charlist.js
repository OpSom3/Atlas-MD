module.exports = {
  ...
  start: async (Miku, m, { text, prefix ,modStatus}) => {
    ...
    let sections = [] 
    let chars = ['Hinata MD', 'Power MD', 'Makima MD', 'Denji MD', 'Zero Two', 'Chika MD' , 'Miku MD', 'Marin MD','Nami MD','Ruka MD','Mizuhara MD','Rem MD','Sumi MD','Kaguya MD','Yumeko MD','Kurumi MD','Mai MD','Yor MD','Shinbou MD','Eiko MD']
